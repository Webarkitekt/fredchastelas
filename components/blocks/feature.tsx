                    ...
                    <div className="relative pt-32 pb-16 ">
                        ...
                        <div className="relative z-10 bg-secondary py-10 px-6 lg:py-20 lg:px-36  rellax" data-rellax-speed="1">
                            ...
                            <div className="uppercase text-primary mb-8" data-tinafield={`${parentField}.subhead`}>{data.subhead}</div>
                                ...
                                <a href={data.link?.url} className="flex flex-row items-center text-interaction-default" data-tinafield={`${parentField}.link`}>
                        ...
                        <div className=" w-48 lg:w-64 absolute z-10 top-0 right-0 rellax" data-rellax-speed="-1">
                            <IllustrationWaves />
                        </div>
                    </div>
                </div>
