...
export const TextAndImage = ({data, parentField}) => {
    return (
        <div className="max-w-screen-xl mx-auto lg:px-16">
            <div className="lg:flex mb-32 lg:space-x-32 lg:pb-20 relative">
            <div className="lg:w-1/2 relative">
                <div className="aspect-[0.76] w-full lg:w-[400px] ">
                    <div className="relative z-10 hidden lg:block">
                        <img src={data.image.src} alt={data.image.alt}/>
                    </div>
                    <div className="bg-secondary h-full w-2/5 absolute top-0 lg:-top-10 z-10 lg:z-0 lg:top-12 right-0"/>
                </div>
            ...
            <div className="lg:w-1/2 px-5 bg-white lg:relative absolute top-16 z-10 mr-6 pt-6">
                <h2 className="font-serif text-4xl lg:text-5xl text-gray-700 mb-12">{data.title}</h2>
                <p className="text-gray-500 leading-loose text-lg font-light mb-12">
                    {data.text}
                </p>
                <a href={data.link.url} className="text-interaction-default align-middle">
