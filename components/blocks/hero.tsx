      ...
      <div className="relative flex flex-col h-full ">
        <div className="max-w-screen-2xl mx-auto flex-grow w-full">
          <div className=" h-full w-full flex flex-col place-content-start ">
            <div
              className={`lg:w-10/12 mx-5 lg:mx-auto ${
                data.as_banner ? `text-gray-700` : `text-white`
              }`}
            >
              <h1
                data-tinafield={`${parentField}.headline`}
                className="font-serif  text-4xl md:text-5xl lg:text-7xl mb-3 leading-[1.4]]"
              >
                {data.headline}
              </h1>
              <h2
